...
@section('content')
    <div class="max-width-1200">
        <form
            action="{{ route('ai-writer.settings') }}"
            method="post"
        >
            @csrf
            ...
            <x-core-setting::section :title="trans('plugins/ai-writer::ai-writer.setting.generate_default')">
            ...
            >
                <div class="form-group mb-3">
                    <label
                        ...
                        for="ai_writer_proxy_enable"
                    >{{ trans('plugins/ai-writer::ai-writer.setting.proxy_enable') }}</label>
                    <label class="me-2">
                        <input
                            ...
                            type="radio"
                            value="1"
                            @if (setting('ai_writer_proxy_enable')) checked @endif
    ...
    @push('footer')
        ...
        <template id="prompt-html-template">
            <div class="mb-4 border rounded-top rounded-bottom p-3 bg-light more-template">
                ...
                <div class="form-group mb-3">
                    <label
                        class="text-title-field">{{ trans('plugins/ai-writer::ai-writer.setting.generate_content') }}</label>
